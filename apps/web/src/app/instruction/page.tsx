...
const roleInstructionsA: Array<{ text: string; indent?: boolean }> = [
  ...
  { text: '材料线索记录：系统会提供多份公司材料。请你按顺序，逐一判断每份材料是否包含与该公司投资判断有关的机会线索或风险线索。一份材料可能只有机会，可能只有风险，也可能同时包含二者。发现相应线索时，选择“有”，并填写能够支持判断的简短证据片段；未发现相应线索时，选择“未发现”。证据片段应来自该份材料，不需要填写完整分析理由。如果该材料完全不包含相关线索，则选择“未发现”，无需填写证据。', indent: true },
          ...
          >
            ...
            <div className="px-5 pb-2 sm:px-10">
              ...
              <section className="border-t border-[#f0f2f5] py-7">
                ...
                <div className="space-y-3 text-[14px] leading-[1.9] text-[#4e5969]">
                  <p>为保证线上实验按照统一方式进行，请在进入后续实验前阅读以下规则。</p>
