...
> 本文档记录 2026-05-27 后确认的实验主流程。  
> 本轮重点更新：
> 1. 两人先按到达顺序组成一组，再在等待室后随机分配角色  
> 2. 角色分配与公司顺序随机化都要保存 seed 和最终结果  
> 3. 指导语后、测试轮后各加一道同步准备屏障  
> 4. 正式任务第一页 A/B 同时起跑，A 在 5 分钟到点后自动提交
...
- 参与者读完指导语后，不直接进入测试轮
- 参与者点击“我已阅读，准备进入测试轮”后，进入同步准备页 1
- 只有自己点过准备，自己才进入同步准备页
- 两人都点完后，系统同时放行进入测试轮
